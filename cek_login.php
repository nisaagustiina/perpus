...
if(isset($_POST['login'])){
    ...
    $sql_login = mysqli_query($con, "SELECT * FROM login WHERE user='$user' AND pass='$pass'");
...
//             $sql = mysqli_query($con, "INSERT INTO login (user,pass,level) VALUES ('$user','$pass','$level')");
